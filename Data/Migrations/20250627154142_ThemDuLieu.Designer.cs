...
namespace Web_Adidas.Data.Migrations
{
    ...
    [Migration("20250627154142_ThemDuLieu")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Web_Adidas.Data.ChiTietDonHang", b =>
                {
                    ...
                    b.HasIndex("SachMaSanPham");

                    b.ToTable("ChiTietDonHang");
                });

            modelBuilder.Entity("Web_Adidas.Data.ChiTietGioHang", b =>
                {
            ...
            modelBuilder.Entity("Web_Adidas.Data.DonHang", b =>
                {
                    b.Property<int>("MaDonHang")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Web_Adidas.Data.GioHang", b =>
                {
                    b.Property<int>("MaGioHang")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Web_Adidas.Data.TheLoai", b =>
                {
            ...
            modelBuilder.Entity("Web_Adidas.Data.TrangThaiDonHang", b =>
                {
                    b.Property<int>("MaTrangThaiDonHang")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Web_Adidas.Data.ChiTietDonHang", b =>
                {
                    b.HasOne("Web_Adidas.Data.DonHang", "DonHang")
                        .WithMany("ChiTietDonHangs")
                        .HasForeignKey("DonHangMaDonHang")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Web_Adidas.Models.SanPham", "Sach")
                        .WithMany("ChiTietDonHangs")
                        .HasForeignKey("SachMaSanPham")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Web_Adidas.Data.ChiTietGioHang", b =>
                {
                    b.HasOne("Web_Adidas.Data.GioHang", "GioHang")
            ...
            modelBuilder.Entity("Web_Adidas.Data.DonHang", b =>
                {
                    b.HasOne("Web_Adidas.Data.TrangThaiDonHang", "TrangThaiDonHang")
                        .WithMany()
            ...
            modelBuilder.Entity("Web_Adidas.Models.SanPham", b =>
                {
                    b.HasOne("Web_Adidas.Data.TheLoai", "TheLoai")
                        .WithMany("SanPhams")
